...
def main(ticker: str) -> dict:
    ...
    return {
        ...
        "data": {
            ...
            "big_v_mentions": f"{big_v_count} influencer mentions" if big_v_count else "—",
            "positive_pct": f"{positive_pct}%",
            "sentiment_label": "Bullish" if positive_pct > 60 else "Bearish" if positive_pct < 40 else "Neutral",
